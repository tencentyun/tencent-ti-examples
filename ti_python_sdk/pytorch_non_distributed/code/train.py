...
parser.add_argument('--ti_submit_directory', type=str, required=False,
                    help='The directory where the code')

# Data and model checkpoints/otput directories from the container environment
parser.add_argument('--model-dir', type=str, default=os.environ['TM_MODEL_DIR'])
parser.add_argument('--output-data-dir', type=str, default=os.environ['TM_OUTPUT_DATA_DIR'])
parser.add_argument('--data-dir', type=str, default=os.environ['TM_CHANNEL_TRAINING'])
